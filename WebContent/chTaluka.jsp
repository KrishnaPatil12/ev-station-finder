...
<title>Charging Station - Taluka</title>
...
<body>
<form action="chTaluka.jsp" class="Login">
<center><h3>View by Taluka</h3></center>
<label>Enter Taluka Name to view Charging Stations :</label>
<input type="text" name="taluka" placeholder="Taluka name here">
...
if(taluka != null ) {
try{
PreparedStatement pstmt=con.prepareStatement("select * from register where taluka=?");
...
<%
    ...
    String backUrl = "index.jsp";  // default fallback
