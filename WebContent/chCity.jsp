...
<title>Charging Station - city</title>
...
<body>
<form action="chCity.jsp" class="Login">
<center><h3>View by City</h3></center>
<label>Enter City Name to view Charging Stations :</label>
...
if(city != null ) {
try{
PreparedStatement pstmt=con.prepareStatement("select * from register where city=?");
